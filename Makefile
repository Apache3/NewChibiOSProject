...
ifeq ($(USE_OPT),)
  USE_OPT = -Os -ggdb -fomit-frame-pointer -falign-functions=32 -specs=nano.specs -specs=nosys.specs -lm
endif
...
# C++ sources that can be compiled in ARM or THUMB mode depending on the global
# setting.
CPPSRC = $(SOURCEDIR)/main.cpp \
         $(SOURCEDIR)/Logging.cpp \
         $(SOURCEDIR)/ProjectShell.cpp
